...
ax1.annotate("157,000", xy=(td.index[13], td[13]), xycoords='data', xytext=(td.index[11], 2000000),
             arrowprops=dict(arrowstyle="->"))
ax1.annotate("11.1 Mn.", xy=(tc.index[13], tc[13]), xycoords='data', xytext=(tc.index[9], 11300000),
             arrowprops=dict(arrowstyle="->"))
...
ax2.annotate("2,459", xy=(nd.index[13], nd[13]), xycoords='data', xytext=(nd.index[9], 200000),
             arrowprops=dict(arrowstyle="->"))
ax2.annotate("322,369", xy=(nc.index[13], nc[13]), xycoords='data', xytext=(nd.index[10], 2000000),
             arrowprops=dict(arrowstyle="->"))
ax2.annotate("2,621,418", xy=(nc.index[8], nc[8]), xycoords='data', xytext=(nd.index[5], 2750000),
             arrowprops=dict(arrowstyle="->"))
fig.autofmt_xdate()
